...
answers = ["Narendra Modi","Sundar Pichai","In 1983","Eknath Shinde","Virat Kohli", "Blue", "Doctor", "Uttar Pradesh", "Yellow", "Mahesh Bhupathi", "Root", "Rising Pune Supergiants", "Hexagon", "Pokemon Go", "CarryMinati", "FIFA Wrold Cup", "Turmeric", "Elon Musk", "Malayalam", "National Parks", "Sevagram", "VK Krishna Menon", "USA-Canada", "England", "West Bengal", "Arogya Setu"]
